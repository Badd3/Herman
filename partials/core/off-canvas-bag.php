<section class="fixed bg-white-bg overflow-y-auto h-full w-full xx:w-5/6 md:w-5/12 lg:w-1/4 z-20 duration-700 ease-in-out" :class="bagOpen ? 'right-0' : '-right-full'">
