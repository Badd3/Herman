...
<section id="reset-password" class="bg-white-bg">
  <div class="flex flex-col items-center justify-center px-2.5 lg:px-6 py-16 lg:py-28 mx-auto">
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="woocommerce-Button button hover:bg-black hover:text-white button hermanBtn alt" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
	</p>
