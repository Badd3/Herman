...
if (is_shop() || is_product_category() || is_product()) {
    ...
    function herman_template_loop_product_link_close()
    {
        ...
        echo '<div class="flex flex-col md:flex-row justify-between md:gap-4 py-2.5 text-sm lg:text-md font-medium">';
    }
    ...
    function loop_product_custom_thumbnail()
    {
        ...
        echo the_post_thumbnail('full', array('class' => $hover_classes));
?>
