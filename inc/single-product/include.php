...
function single_product_images()
{
    ...
    echo '<a class="chocolat-image zoom-cursor [&_>img]:w-full" href="' . $thumbnail_url . '" class="aspect-w-[54] aspect-h-[73] [&>*]:object-cover">';
    the_post_thumbnail();
    echo '</a>';
    ...
    foreach ($attachment_ids as $attachment_id) {
        ...
        echo '<a class="chocolat-image zoom-cursor [&_>img]:w-full" href="' . $attachment_url . '" class="aspect-w-[54] aspect-h-[73] [&>*]:object-cover">';
            ...
            <div class="flex flex-row border-x border-black border-b border-b-black">
                ...
                <div class=" py-1 flex flex-row flex-wrap gap-x-4 px-3">
                    ...
                    ?>
                            ...
                            <a class="flex flex-row-reverse flex-nowrap items-center gap-2" href="<?php the_permalink(); ?>">
